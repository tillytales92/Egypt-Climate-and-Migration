...
era5_temp_df <- readRDS(file = paste(here(),"Data","intermediate","ERA5","era5_temp_19602024.Rds",
                                     sep = "/"))

era5_temp_annual <- readRDS(file = paste(here(),"Data","intermediate","ERA5","era5_temp_annual_19602024.Rds",
                                         sep = "/"))
