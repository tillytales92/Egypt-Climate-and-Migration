...
#These will be used in "2_Extraction_HH_TravelDistances.R" to calc. HH distance
...
ghsl_2020_1 <- terra::rast(paste(here(),"Data","raw","GHSL",
              "GHS_BUILT_S_E2020_GLOBE_R2023A_54009_100_V1_0_R6_C21.tif",sep = "/"))

ghsl_2020_2 <- terra::rast(paste(here(),"Data","raw","GHSL",
              "GHS_BUILT_S_E2020_GLOBE_R2023A_54009_100_V1_0_R6_C22.tif",sep = "/"))

ghsl_2020_3 <- terra::rast(paste(here(),"Data","raw","GHSL",
               "GHS_BUILT_S_E2020_GLOBE_R2023A_54009_100_V1_0_R7_C21.tif",sep = "/"))

ghsl_2020_4 <- terra::rast(paste(here(),"Data","raw","GHSL",
               "GHS_BUILT_S_E2020_GLOBE_R2023A_54009_100_V1_0_R7_C21.tif",sep = "/"))
...
pop_2020_1 <- terra::rast(paste(here(),"Data","raw","GHSL",
                "GHS_POP_E2020_GLOBE_R2023A_54009_100_V1_0_R6_C21.tif",sep = "/"))

pop_2020_2 <- terra::rast(paste(here(),"Data","raw","GHSL",
                "GHS_POP_E2020_GLOBE_R2023A_54009_100_V1_0_R6_C22.tif",sep = "/"))

pop_2020_3 <- terra::rast(paste(here(),"Data","raw","GHSL",
                "GHS_POP_E2020_GLOBE_R2023A_54009_100_V1_0_R7_C21.tif",sep = "/"))

pop_2020_4 <- terra::rast(paste(here(),"Data","raw","GHSL",
...
st_write(towns_10k,dsn =
           paste(here(),"Data","intermediate","Market Towns",
          "markettowns.shp",sep = "/"))
