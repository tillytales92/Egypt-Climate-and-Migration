...
prec_chirps <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
...
######Yearly stack#####
raster::writeRaster(prec_chirps_cropped_monthly,
                    filename = paste(here(),"Data", "Precipitation",
                                     "CHIRPS",
                                     "prec_chirps_yearlysum_19812024_cropped.tif",
                                     sep = "/"))
...
raster::writeRaster(prec_chirps_cropped_monthly,
                    filename = paste(here(),"Data", "Precipitation",
                    "CHIRPS",
                    "prec_chirps_monthlysum_19812024_cropped.tif",sep = "/"))
...
#Yearly data
#R
saveRDS(chirps_prec_yearly,file = paste(here(),"Data",
                                         "Precipitation","CHIRPS","Panel",
                                         "chirps_prec_yearly_19812024",sep = "/"))

#CSV
write_csv(chirps_prec_yearly,file = paste(here(),"Data",
                                           "Precipitation","CHIRPS","Panel",
                                           "chirps_prec_yearly_19812024.csv",sep = "/"))
...
#CSV
write_csv(chirps_prec_monthly,file = paste(here(),"Data",
                                  "Precipitation","CHIRPS","Panel",
                                  "chirps_prec_monthly_19812024.csv",sep = "/"))
...
#CSV
write_csv(chirps_prec_daily,file = paste(here(),"Data",
                                           "Precipitation","CHIRPS","Panel",
                                           "chirps_prec_daily_19812024.csv",sep = "/"))
