...
#1980 raster
chirps_prec_1980 <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
                                     "chirps_1981_1990_daily.tif",sep = "/"))

#1990 raster
chirps_prec_1990 <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
                                      "chirps_1991_2000_daily.tif",sep = "/"))

#2000 raster
chirps_prec_2000 <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
                                      "chirps_2001_2010_daily.tif",sep = "/"))

#2010 raster
chirps_prec_2010 <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
                                      "chirps_2011_2020_daily.tif",sep = "/"))

#2020 raster
chirps_prec_2020 <- terra::rast(paste(here(),"Data", "Precipitation","CHIRPS",
