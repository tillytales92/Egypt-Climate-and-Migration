...
#Direct extraction at point location ---------------------------------------
#extract elevation at household location
#works well and fast but does not give me the slope;
#for slope i need the DEM raster
# elev_hh <- get_elev_point(
#   locations = hh_data_imputedgps_sf,
#   z = 10,
#   src = "aws")

#Save Data ---------------------------------------------------------------
saveRDS(hhdata_dem,
        file = paste(here(),"Data","Elevation",
                     "hhdata_dem.rds",sep ="/"))
