...
hh_temp_variables <- readRDS(file = paste(here(),"Data",
                     "Temperature","ERA5","Panel","hh_temp_variables.Rds",sep = "/"))

#Done in R - see Script "2_Elevation_Extraction.R" -> Updated (11.11.2025)
#Elevation/Slope data
hhdata_dem <- readRDS(file = paste(here(),"Data",
                                   "Elevation","hhdata_dem.rds",sep = "/"))

#Done in R
##HH dist. to waterways -> Updated (11.11.2025)
hh_distwaterways <- readRDS(file = paste(here(),"Data",
                                         "Nile","hh_distwaterways.rds",sep = "/"))

#Done in "2_Extraction_ESI_HHPanel" --> Updated (26.11.2025)
#HH ESI
hh_esi <- readRDS(file = paste(here(),"Data", "Drought Indices","ESI",
                               "hh_esi_20002024.Rds",sep = "/"))

#Done in "2_Extraction_NDVI_HHPanel" --> Updated (26.11.2025)
#HH Vegetation Indices
hh_shocks_vegetationindices <- readRDS(file = paste(here(),"Data","Drought Indices",
                                      "NDVI",
